...
STATE_DIR="${ROOT_DIR}/.guardian-tunnels"
...
SSH_LOCAL_PORT="${GUARDIAN_SSH_LOCAL_PORT:-${VM_LOCAL_SSH_PORT}}"
AGENT_LOCAL_PORT="${GUARDIAN_AGENT_LOCAL_PORT:-3000}"
MCP_LOCAL_PORT="${GUARDIAN_MCP_LOCAL_PORT:-8080}"
DISABLE_CONNECTION_CHECK="${GUARDIAN_TUNNEL_DISABLE_CONNECTION_CHECK:-true}"
...
smoke() {
  ...
  http_smoke "guardian-mcp" "${MCP_LOCAL_PORT}" "/api/v1/stream/mcp" || failed=1
  http_smoke "guardian-agent" "${AGENT_LOCAL_PORT}" "/" || failed=1
