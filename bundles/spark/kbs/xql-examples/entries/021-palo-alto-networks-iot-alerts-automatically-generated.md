...
Palo Alto Networks IoT Alerts (automatically generated). Queries the `palo_alto_networks_iot_generic_alert_raw` dataset directly, filtered on `_alert_data != null`. Uses stages: `filter`, `alter`.
