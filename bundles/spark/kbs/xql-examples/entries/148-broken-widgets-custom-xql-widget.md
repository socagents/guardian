...
broken_widgets - Custom XQL Widget. Queries the `corelight_zeek_raw` dataset directly, filtered on `_path = "suricata_corelight" and alert_signature contains "ETPRO HUNTING"`. Uses stages: `fields`, `filter`, `comp`, `view`.
