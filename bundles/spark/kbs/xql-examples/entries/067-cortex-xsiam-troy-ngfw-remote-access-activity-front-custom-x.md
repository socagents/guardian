...
Cortex XSIAM Troy NGFW Remote Access Activity [Front] - Custom XQL Widget. Queries the `panw_ngfw_traffic_raw` dataset directly, filtered on `url_category = "proxy-avoidance-and-anonymizers" and (app not in("""ssl""", """web-browsing""", """incomplete"""))`. Uses stages: `filter`, `alter`, `comp`, `fields`, `sort`, `limit`.
