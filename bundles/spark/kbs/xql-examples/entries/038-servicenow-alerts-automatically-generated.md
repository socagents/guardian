...
ServiceNow Alerts (automatically generated). Queries the `servicenow_generic_alert_raw` dataset directly, filtered on `_alert_data != null`. Uses stages: `filter`, `alter`.
