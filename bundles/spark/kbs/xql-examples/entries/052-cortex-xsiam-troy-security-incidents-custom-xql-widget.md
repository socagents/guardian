...
Cortex XSIAM Troy Security Incidents - Custom XQL Widget. Queries the `panw_ngfw_` dataset directly, filtered on `from_zone = "internet"`. Uses stages: `fields`, `filter`, `iploc`, `comp`, `sort`.
