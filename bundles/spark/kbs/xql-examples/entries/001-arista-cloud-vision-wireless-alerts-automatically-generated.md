...
Arista Cloud Vision Wireless Alerts (automatically generated). Queries the `arista_cloud_vision_wireless_generic_alert_raw` dataset directly, filtered on `_alert_data != null`. Uses stages: `filter`, `alter`.
