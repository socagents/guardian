...
**MCP tool**: `xsiam_response_get_file_retrieval_details`
...
- Generated from `ebarti/xsiam-client`'s `get_file_retrieval_details` wrapper — see https://github.com/ebarti/xsiam-client for the authoritative Python implementation.
...
- Guardian tool: `bundles/spark/connectors/xsiam/src/connector.py` → `xsiam_response_get_file_retrieval_details`
