...
**MCP tool**: `xdr_response_get_action_status`
**Guardian connector**: `cortex-xdr` (per-instance: see Tools tab on `/connectors/cortex-xdr-<instance>`)

**Official docs**: https://docs.paloaltonetworks.com/cortex/cortex-xdr/cortex-xdr-api/cortex-xdr-apis/response-actions/get-action-status.html
...
- Generated from `ebarti/cortex-xdr-client`'s `get_action_status` wrapper — see https://github.com/ebarti/cortex-xdr-client for the authoritative Python implementation.
...
- Guardian tool: `bundles/spark/connectors/cortex-xdr/src/connector.py` → `xdr_response_get_action_status`
