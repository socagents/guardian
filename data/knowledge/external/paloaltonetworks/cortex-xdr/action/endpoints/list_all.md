...
**MCP tool**: `xdr_endpoints_list_all`
...
- Generated from `ebarti/cortex-xdr-client`'s `get_all_endpoints` wrapper — see https://github.com/ebarti/cortex-xdr-client for the authoritative Python implementation.
...
- Guardian tool: `bundles/spark/connectors/cortex-xdr/src/connector.py` → `xdr_endpoints_list_all`
