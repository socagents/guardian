...
const GUARDIAN_CONNECTORS: MarketplaceConnector[] = [
  // ── xsoar ───────────────────────────────────────────────────────────────
  {
    ...
    // by loadLiveMeta() below (currently 37). Keep this in step with the yaml.
    toolCount: 37,
