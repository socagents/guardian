...
const GUARDIAN_CONNECTORS: MarketplaceConnector[] = [
  // ── xsoar ───────────────────────────────────────────────────────────────
  {
    ...
    // by loadLiveMeta() below (currently 38). Keep this in step with the yaml.
    toolCount: 38,
