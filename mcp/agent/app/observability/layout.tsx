...
/**
 * Observability shell — guardian version.
 *
 * Spark's observability tab bar + Grafana link + datasource indicators
 * are removed here. Guardian is self-contained: there's no Grafana,
 ...
 * /observability/* renders against those guardian-internal endpoints.
 *
