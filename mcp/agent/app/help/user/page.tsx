          ...
          >
            ...
            <SubSection icon="description" title="The Issue layout">
              ...
              <ul className="list-disc pl-5 space-y-1.5 text-sm">
                ...
                <li>
                  <Term>Attack chain</Term> — an SVG causality diagram of the
                  attack, generated by Guardian&apos;s diagramming skill{" "}
                  (arriving in v0.1.8; the tab is present now as a placeholder).
                </li>
              </ul>
              <p>
