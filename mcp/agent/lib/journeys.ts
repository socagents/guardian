...
export const JOURNEYS: Journey[] = [
...

  {
    ...
    howToTest: [
      ...
      "Submit. The create returns immediately (the container start runs in the background) with an amber 'still starting' notice; the instance card appears right away, and a red banner shows only if the create itself failed. The 201 body carries runtime_style='container' + container_start={started:null, pending:true}. After a few seconds, `docker ps` shows guardian-connector-web-primary up + healthy.",
